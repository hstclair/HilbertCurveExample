...
public class HilbertCurveSegmentTest {
    ...
    public static final GrayCode grayCode = new GrayCode();
    ...
    public void applyBasis() {
        ...
        long[] inputValues = new long[] {
                grayCode.decode(0x95),
                grayCode.decode(0x56),
                grayCode.decode(0x37),
                grayCode.decode(0xc2),
                grayCode.decode(0x02),
                grayCode.decode(0x96),
                grayCode.decode(0x47),
                grayCode.decode(0x02),
                grayCode.decode(0x77),
                grayCode.decode(0xf6),
                grayCode.decode(0x27),
                grayCode.decode(0xb6),
                grayCode.decode(0x37)
        };
